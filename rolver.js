...
.setMaxValues(1)
    ...
    // Yasaklanacak rollerin ID'lerini tanımlayalım
    const yasakliRoller = ["1193971061797159054", "1217931754573267055"];
    ...
    collector.on('collect', async (interaction) => {
      if (interaction.customId === 'test2') {
        ...
        // Yasaklı rollerin kontrolü
        if (yasakliRoller.includes(selectedRoleId)) {
          return interaction.reply({ content: "Bu rolü verme yetkiniz bulunmamaktadır." });
        }
